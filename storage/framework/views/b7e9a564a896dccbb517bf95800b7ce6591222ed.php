...
============================================= -->
                    ...
                    <div class="header-row">
                        ...
                        <nav class="primary-menu with-arrows block-mega-menu-4">
                            ...
                            <ul class="menu-container">
                                ...
                                <li class="menu-item"><a class="menu-link" href="<?php echo e(route('dashboard')); ?>">
                                        <div><?php echo e(__('common.admin')); ?></div>
                                    </a></li>
                                <?php endif; ?>
                                <li class="menu-item"><a class="menu-link" href="<?php echo e(route('my_meetings')); ?>">
                                        <div><?php echo e(__('common.dashboard')); ?></div>
                                    </a></li>
                                <li class="menu-item mega-menu mega-menu-small sub-menu">

                                    <a href="#" class="menu-link">
                                        <div><?php echo e(Auth::user()->name); ?><i class="icon-angle-down"></i></div>
                                    </a>
                                    <div class="mega-menu-content mega-menu-style-2 rounded-3" style="display: none;">
                                        <ul class="sub-menu-container mega-menu-column px-2 py-3" style="display: none;">
                                            ...
                                            <li class="menu-item">
                                                <a class="menu-link" href="<?php echo e(route('change_password')); ?>">
                                                    <h4 class="mb-0 h6 nott ls0 fw-semibold"><?php echo e(__('common.change_password')); ?></h4>
                                                </a>
                                            </li>
                                            <li class="menu-item">
                                            <form method="POST" action="<?php echo e(route('logout')); ?>"><?php echo csrf_field(); ?>
                                                <a class="menu-link" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); this.closest('form').submit();">
                                                    <h4 class="mb-0 h6 nott ls0 fw-semibold"><?php echo e(__('common.logout')); ?></h4>
                                                </a>
                                            </form>
                                            </li>
    ...
    <script src="<?php echo e(asset('front_assets/js/plugins.js')); ?>"></script>
...
</html><?php /**PATH F:\xampp\htdocs\justalk1\resources\views/front/layouts/app.blade.php ENDPATH**/ ?>