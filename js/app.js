// مدير واجهة المستخدم لتطبيق الدردشة
function myjsapp(peerClient) {
    ...
    function EventListeners() {
        ...
        $('#peer-id').click(function (event) {
            ...
            // تجنب وميض الصندوق الأبيض إذا تم تقديمه لأي سبب من الأسباب.
    ...
    return {
        ...
        createChatWindow: function(id) {
            ...
            // TODO - إخفاء اللوحات إذا كانت أكثر من 3
        },
        ...
        updateOnlieUsers : function (users) {
            ...
            list.empty()
            if(users.length == 0) {
                var usr = '<li>يبدو أنه لا يوجد أحد متصل بالإنترنت</li>'
                list.append(usr);
                return
            }
